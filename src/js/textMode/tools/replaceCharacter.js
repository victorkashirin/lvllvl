var ReplaceCharacterDialog = function() {
...
ReplaceCharacterDialog.prototype = {
  ...
  show: function() {
    ...
    if(this.uiComponent == null) {
      ...
      var _this = this;
      this.uiComponent = UI.create("UI.Dialog", { "id": "replaceCharacterDialog", "title": "Replace Tile", "width": 300, "height": 200 });
  ...
  initEvents: function() {
    ...
    $('#replaceCharacterCanvas').on('click', function() {

      var args = {};
      args.characterPickedCallback = function(character) {
        _this.setReplaceTile(character);
    ...
    $('#replaceWithCharacterCanvas').on('click', function(event) {
...
//      args['color'] = 2;
  ...
  doReplaceTile: function() {
    ...
    this.frames = $('input[name=replaceCharacterFrame]:checked').val();
    ...
    for(var frameIndex = fromFrame; frameIndex < toFrame; frameIndex++) {
      ...
      for(var y = fromY; y < toY; y++) {
        for(var x = fromX; x < toX; x++) {
          ...
          if(cellData.t == this.replaceTile) {
